...
CREATE TABLE `order_item` (
  ...
  CONSTRAINT `order_item_ibfk_2` FOREIGN KEY (`id_product`) REFERENCES `product` (`id_product`) ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `product` (
  `id_product` char(36) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT (uuid()),
  ...
  KEY `idx_price` (`price`),
  FULLTEXT KEY `idx_fulltext_product` (`name`,`description`,`ingredient`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `product` VALUES ('67f63395-c07a-11f0-baf9-90e86841aae8','Pizza Margherita','Pizza classique italienne avec tomate et mozzarella',12.50,50,'Tomate, Mozzarella, Basilic, Huile d\'olive','Cuire au four à 220°C pendant 15 minutes',NULL,'Pizza',1,'2025-11-13 10:20:41','2025-11-13 10:20:41'),('67f635e4-c07a-11f0-baf9-90e86841aae8','Pizza 4 Fromages','Pizza avec 4 fromages italiens',14.90,30,'Mozzarella, Gorgonzola, Parmesan, Fontina','Cuire au four à 220°C pendant 15 minutes',NULL,'Pizza',1,'2025-11-13 10:20:41','2025-11-13 10:20:41'),('67f636e0-c07a-11f0-baf9-90e86841aae8','Pizza Pepperoni','Pizza avec pepperoni épicé',13.90,40,'Tomate, Mozzarella, Pepperoni','Cuire au four à 220°C pendant 15 minutes',NULL,'Pizza',1,'2025-11-13 10:20:41','2025-11-13 10:20:41'),('67f637d6-c07a-11f0-baf9-90e86841aae8','Tiramisu','Dessert italien traditionnel',6.50,20,'Mascarpone, Café, Cacao, Biscuits','Réfrigérer 4 heures avant de servir',NULL,'Dessert',1,'2025-11-13 10:20:41','2025-11-13 10:20:41'),('67f638c2-c07a-11f0-baf9-90e86841aae8','Coca-Cola 33cl','Boisson gazeuse',2.50,100,NULL,NULL,NULL,'Boisson',1,'2025-11-13 10:20:41','2025-11-13 10:20:41');
...
INSERT INTO `user_account` VALUES ('4848e16d-0ec1-4ab2-a461-e1d31c597c45','Marie','Dupont','F','marie.dupont@example.com','0612345678','123 Rue de la Paix','Appartement 4B','Paris','75001','France','$2b$10$kKsZgW.ze4xPMiRx7ae5vemiXdfaz7Ucm1tHi7DbLw.QvWQZibYpC','CLIENT','2025-11-13 13:46:13','2025-11-13 13:46:13'),('67f53fb9-c07a-11f0-baf9-90e86841aae8','Admin','System',NULL,'admin@example.com',NULL,NULL,NULL,NULL,NULL,'France','$2b$10$YourHashedPasswordHere','ADMIN','2025-11-13 10:20:41','2025-11-13 10:20:41'),('67f5ad58-c07a-11f0-baf9-90e86841aae8','John','Doe',NULL,'john@example.com',NULL,NULL,NULL,NULL,NULL,'France','$2b$10$YourHashedPasswordHere','CLIENT','2025-11-13 10:20:41','2025-11-13 10:20:41');
...
-- Dump completed on 2025-11-17  8:44:24
