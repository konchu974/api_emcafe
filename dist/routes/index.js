...
router.get("/orders/my-orders", authMiddleware_1.authMiddleware, orderController.getMyOrders); // ✅ AVANT /orders/:id
...
router.post("/orders/:id/create-label", authMiddleware_1.authMiddleware, authMiddleware_1.adminMiddleware, orderController.createLabel);
...
router.post("/orders", (0, validationMiddleware_1.validationMiddleware)(CreateOrderDto_1.CreateOrderDto), // ✅ ENLEVER authMiddleware si commande invité
