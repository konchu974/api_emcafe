    ...
    constructor() {
        ...
        this.createOrder = async (req, res) => {
            try {
                ...
                const createOrderDto = (0, class_transformer_1.plainToInstance)(CreateOrderDto_1.CreateOrderDto, req.body, {
                ...
                const errors = await (0, class_validator_1.validate)(createOrderDto, {
                    whitelist: true,
         ...
         */
        this.createLabel = async (req, res) => {
            try {
